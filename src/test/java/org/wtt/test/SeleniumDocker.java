...
public void AddCustomer() {
	...
	Random r = new Random();
	int max = 1000;
	String name1 = "SampleName"+r.nextInt(max);
	...
	driver.findElement(By.name("email")).sendKeys(name1+"@gmail.com");
...
public void Logout() {
	driver.findElement(By.xpath("@Test(priority=8,description = \"verify Adding Customer\")")).click();
	System.out.println("Logout Successfully");
